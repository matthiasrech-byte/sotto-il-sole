 ...
 * @beta
 */
declare const component: (componentOrSpec?: UserViewComponent$1 | Partial<ComponentView$1>) => ComponentViewBuilder$1;
/**
 * @deprecated Import from `sanity/structure` instead!
 * @hidden
 * @beta
 ...
 * @beta
 */
declare const form: (spec?: Partial<FormView$1>) => FormViewBuilder$1;
/**
 * @deprecated Import from `sanity/structure` instead!
 * @hidden
 * @beta
