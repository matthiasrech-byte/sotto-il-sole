...
declare const presentationMachine: import("xstate").StateMachine<Context$2, {
...
}, "busy" | "error", import("xstate").NonReducibleUnknown, import("xstate").NonReducibleUnknown, import("xstate").EventObject, import("xstate").MetaObject, {
...
declare const previewUrlMachine: import("xstate").StateMachine<Context$1, SetPreviewSearchParamEvent, {
  [x: string]: import("xstate").ActorRefFromLogic<import("xstate").ObservableActorLogic<PermissionCheckResult, CheckPermissionInput, import("xstate").EventObject>> | import("xstate").ActorRefFromLogic<import("xstate").PromiseActorLogic<URLPattern[], {
    initialUrl: URL;
  }, import("xstate").EventObject>> | import("xstate").ActorRefFromLogic<import("xstate").PromiseActorLogic<URL, ResolvePreviewModeUrlInput, import("xstate").EventObject>> | import("xstate").ActorRefFromLogic<import("xstate").PromiseActorLogic<URL, {
    initialUrl: URL;
    previewSearchParam: string | null | undefined;
    allowOrigins: URLPattern[];
  }, import("xstate").EventObject>> | import("xstate").ActorRefFromLogic<import("xstate").PromiseActorLogic<URL, {
    previewSearchParam: string | null;
  }, import("xstate").EventObject>> | import("xstate").ActorRefFromLogic<import("xstate").PromiseActorLogic<{
    secret: string;
    expiresAt: Date;
  }, import("xstate").NonReducibleUnknown, import("xstate").EventObject>> | import("xstate").ActorRefFromLogic<import("xstate").PromiseActorLogic<string | null, import("xstate").NonReducibleUnknown, import("xstate").EventObject>> | import("xstate").ActorRefFromLogic<import("xstate").PromiseActorLogic<false | PreviewUrlPreviewMode, {
    targetOrigin: string;
  }, import("xstate").EventObject>> | undefined;
}, {
  src: "check permission";
  logic: import("xstate").ObservableActorLogic<PermissionCheckResult, CheckPermissionInput, import("xstate").EventObject>;
  id: string | undefined;
} | {
  ...
  logic: import("xstate").PromiseActorLogic<string | null, import("xstate").NonReducibleUnknown, import("xstate").EventObject>;
  id: string | undefined;
} | {
  src: "resolve allow patterns";
  logic: import("xstate").PromiseActorLogic<URLPattern[], {
    initialUrl: URL;
  }, import("xstate").EventObject>;
  id: string | undefined;
} | {
  src: "resolve initial url";
  logic: import("xstate").PromiseActorLogic<URL, {
    previewSearchParam: string | null;
  }, import("xstate").EventObject>;
  id: string | undefined;
} | {
  src: "resolve preview mode";
  logic: import("xstate").PromiseActorLogic<false | PreviewUrlPreviewMode, {
    targetOrigin: string;
  }, import("xstate").EventObject>;
  id: string | undefined;
} | {
  src: "resolve preview mode url";
  logic: import("xstate").PromiseActorLogic<URL, ResolvePreviewModeUrlInput, import("xstate").EventObject>;
  id: string | undefined;
} | {
...
}, "busy" | "error", Input, import("xstate").NonReducibleUnknown, import("xstate").EventObject, import("xstate").MetaObject, {
  id: "Preview URL";
  states: {
