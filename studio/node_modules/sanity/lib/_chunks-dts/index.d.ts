...
declare const structureLocaleStrings: {
  ...
  'panes.document-list-pane.search-input.placeholder': string; /** The tooltip text shown when a sort menu item references fields not present in the current schema */
