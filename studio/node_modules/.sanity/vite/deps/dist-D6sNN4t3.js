	...
	renderChildren() {
		...
		return this.state.expanded && (isObject(data) || Array.isArray(data)) ? Object.keys(data).map((key) => {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Leaf, {
				...
				id: id2,
				query,
				getOriginal: !this.state.original || (verboseShowOriginal ? query : !1) ? getOriginal : void 0,
				isExpanded,
				interactiveLabel,
				verboseShowOriginal
...
var noop = (...args) => {}, SearchBar = ({ onChange = noop }) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
		className: "json-inspector__search",
		type: "search",
		placeholder: "Search",
		onChange: (0, import_react.useCallback)((evt) => onChange(evt.target.value), [onChange])
	});
};
...
var defaultValidateQuery = (query) => query.length >= 2, defaultFilterOptions = {
	cacheResults: !0,
	ignoreCase: !1
};
...
//# sourceMappingURL=dist-D6sNN4t3.js.map