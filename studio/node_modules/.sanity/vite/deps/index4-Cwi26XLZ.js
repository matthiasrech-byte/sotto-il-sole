...
import { $p as createOperatorSubscriber, Ad as require_speakingurl, Ah as Flex, Au as useSchema, Cp as scan, Dh as Card, Gh as Stack, Gp as of, Hh as PortalProvider, Hp as firstValueFrom, If as isEqual, Jh as Text, Kp as from, Mf as useRouter, Mh as Heading, Nf as useRouterState, Oh as Code, Pp as NEVER, Qg as SyncIcon, Qp as refCount, Tf as v4, Th as Box, Tp as distinctUntilChanged, Up as isObservable, Vp as map, Xd as omit, Xu as useTranslation, Yp as ReplaySubject, a_ as WarningOutlineIcon, af as Button, bp as startWith, dp as ResolvedPanesProvider, em as operate, hf as generateHelpUrl, hi as _isCustomDocumentTypeDefinition, hl as useDocumentStore, kh as Container, l_ as gt, m_ as require_compiler_runtime, nf as isHotkey, ng as useTheme, o_ as require_react_is, os as isRecord$4, sf as ErrorBoundary, ud as useWorkspace, vr as SourceProvider, wp as publishReplay, xh as useToast, yp as switchMap, zp as concat } from "./lib-BW6s_CyC.js";
import { M as useStructureTool, X as StructureToolProvider, Y as SerializeError, b as StructureToolPane, d as LoadingPane, mt as structureLocaleNamespace, u as LOADING_PANE, v as PaneLayout, w as setActivePanes, x as assignId, y as StructureTitle } from "./structureTool-C53tzSmF.js";
...
var isPromise = (thing) => !!thing && typeof thing?.then == "function", isSerializable = (thing) => isRecord$4(thing) ? typeof thing.serialize == "function" : !1, rethrowWithPaneResolutionErrors = (next) => (unresolvedPane, context, flatIndex) => {
	try {
...
var EMPTY_RECORD = {}, IntentResolver = (0, import_react.memo)(function() {
	const $ = (0, import_compiler_runtime.c)(7), { navigate } = useRouter(), maybeIntent = useRouterState(_temp$3), { rootPaneNode, structureContext } = useStructureTool(), documentStore = useDocumentStore(), [error, setError] = (0, import_react.useState)(null);
	if (error) throw error;
	let t0, t1;
	return $[0] !== documentStore || $[1] !== maybeIntent || $[2] !== navigate || $[3] !== rootPaneNode || $[4] !== structureContext ? (t0 = () => {
		...
		rootPaneNode,
		structureContext
	], $[0] = documentStore, $[1] = maybeIntent, $[2] = navigate, $[3] = rootPaneNode, $[4] = structureContext, $[5] = t0, $[6] = t1) : (t0 = $[5], t1 = $[6]), (0, import_react.useEffect)(t0, t1), null;
});
...
var StyledPaneLayout = gt(PaneLayout).withConfig({
	...
	$[17] !== navigate || $[18] !== paneDataItems || $[19] !== routerState?.panes || $[20] !== setMaximizedPane ? (t10 = () => {
		...
		navigate({ panes: (routerState?.panes || []).map(_temp5) }, { replace: !0 });
	...
	if ($[27] !== maximizedPane || $[28] !== paneDataItems || $[29] !== setMaximizedPane ? (t13 = () => {
		...
		if (previousSelectedIndexRef.current = selectedIndex, !!maximizedPane) {
			...
			if (!paneDataItems.some((pane_3) => pane_3.key === maximizedPane.key)) setMaximizedPane(paneDataItems.find((pane_4) => pane_4.groupIndex === maximizedPane.groupIndex && pane_4.siblingIndex === maximizedPane.siblingIndex && pane_4.pane !== LOADING_PANE && pane_4.pane.type === "document") || null);
		}
	}, t14 = [
		maximizedPane,
		paneDataItems,
...
//# sourceMappingURL=index4-Cwi26XLZ.js.map