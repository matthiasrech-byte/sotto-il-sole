import { n as __commonJSMin } from "./react-Dc_4GEhg.js";
	...
	(function(global) {
		...
		TextDecoderPolyfill.prototype.decode = function(octets) {
			...
			for (var i = 0; i < octets.length; i += 1) {
				...
				if (bitsNeeded === 0) if (codePoint <= 65535) string += String.fromCharCode(codePoint);
				else {
		...
		function start(es, url, options) {
			...
			var onStart = function(status, statusText, contentType, headers) {
				if (currentState === CONNECTING) if (status === 200 && contentType != void 0 && contentTypeRegExp.test(contentType)) {
					currentState = OPEN;
...
//#endregion
//#region node_modules/@sanity/eventsource/browser.js
...
//# sourceMappingURL=browser-ChUpkVSr.js.map